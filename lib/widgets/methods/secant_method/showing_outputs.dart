...
class ShowingOutputs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Output> sol = MC.SecantMethod(xNumbers, LOI);
    Widget itersText = Text("Number of iterations : ${sol.length}");
    return Scaffold(
      // appBar: AppBar(title: const Text("Secant Method Answer")),
      body: Center(
          child: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    if (sol[i].a == 0.0 && sol[i].b == 0) {
                      return Column(
                        children: [const Text("ERR : F(p₀) = F(p₁)")],
                      );
                    } else
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: AutoSizeText(
                                    overflow: TextOverflow.fade,
                                    "f(p₁)= ${sol[i].f1.toStringAsFixed(6)}"),
                              ),
                            ],
                          ),
                        ],
